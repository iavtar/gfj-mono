...
import CreateQuotationMob from "./CreateQuotationMob";
      ...
      >
        <Box className="absolute inset-0 bg-white z-10 overflow-y-auto">
          <Button
            variant="contained"
            onClick={handleBack}
            className={`w-[30px] h-[50px] !rounded-lg flex items-center justify-center !absolute !top-[16px] !left-[10px] !z-10 !bg-[var(--brand-purple)]
          ...
          >
            {({ errors, touched, setFieldValue, values }) => (
              <Form className="h-full flex flex-col">
                ...
                {/* Scrollable Section for both client selector + cards, and data */}
                <div
                ...
                >
                  <div className="flex-shrink-0">
                    ...
                    >
                      ...
                      <CustomButton
                        ...
                        } ${isMobile ? "!text-xs !px-2 !h-[40px]" : ""}`}
                      >
                        Create Quotation
                      </CustomButton>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-6 mb-8 p-2">
                      <div className="!rounded-xl !shadow-md flex-1">
                        <Card
                        ...
                        >
                          <CardContent>
                            ...
                            >
                              <span
                                className={`bg-gray-200 text-gray-600 py-2 ${
                                  isMobile ? "px-3" : "px-4"
                  ...
                  {/* Data Section - Fixed height to prevent page shifts */}
                    ...
                    {data?.rounds && (
                      <Box className="mb-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                          {Object.entries(data.rounds).map(
                            ([range, values]) => (
                              <div key={range}>
                                <SizeCard
                                  sizeRange={range}
                            ...
                            <thead className="bg-gray-200 sticky top-0 z-10">
                              <tr>
                                <th
                                  ...
                                  } text-left font-semibold text-gray-900 border-b border-gray-300`}
                                >
                                  Cut Type
                                </th>
                                <th
                                  className={`${
                                    isMobile ? "px-2 py-2 text-sm" : "px-4 py-3"
                                  } text-center font-semibold text-gray-900 border-b border-gray-300`}
                                >
                                  Quantity
                                </th>
                                <th
